 ...
 * Repetition tracker (PRN-US-07 / US-75), both gated behind a completed baseline assessment.
 *
    ...
    <div className="flex flex-col gap-8">
      ...
      {!isUnlocked ? (
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* PRN-US-07 / US-75: Cross-Session Trouble Words Bank & Spaced Repetition */}
          <section className="flex flex-col gap-4">
            ...
            {words === null ? (
              ...
              <div className="flex min-h-[30vh] flex-col items-center justify-center gap-4 rounded-2xl border border-dashed border-border p-12 text-center">
