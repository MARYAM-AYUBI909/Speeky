...
async def publish_transcript(room: rtc.Room, result: dict) -> None:
    """Publish the transcript, duration, and word timings to the frontend."""
    ...
    try:
        ...
        logger.info(
            "Sent transcript to frontend: %r (%d words, %.2fs)",
            result["text"],
